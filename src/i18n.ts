...
const en = {
  ...
  activityImportedMediaFilesFrom:
    'Imported {count} media files from {sourceLabel}',
  ...
  countingFilesIn: 'Counting files in {sourceLabel}',
  captured: 'Captured',
  display: 'Display',
  distance: 'Distance',
  ...
  savingMediaFiles: 'Saving {count} media files',
...
const de: Record<TranslationKey, string> = {
  ...
  activityImportedMediaFilesFrom:
    '{count} Mediendateien aus {sourceLabel} importiert',
  ...
  clearCatalogConfirm:
    'Katalog leeren? Dadurch werden indizierte Medien, Quellen und generierte Vorschaubilder aus dieser App entfernt. Originaldateien bleiben auf der Festplatte.',
  clearSearch: 'Suche löschen',
  closeViewer: 'Viewer schließen',
  countingFilesIn: 'Dateien in {sourceLabel} werden gezählt',
  ...
  savingMediaFiles: '{count} Mediendateien werden gespeichert',
