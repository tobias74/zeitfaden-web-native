...
const en = {
  ...
  timelineGroupsRange: '{start}-{end} of {total} groups',
  ...
  importGeoFolder: 'Import geo folder',
...
const de: Record<TranslationKey, string> = {
  ...
  timelineGroupsRange: '{start}-{end} von {total} Gruppen',
  ...
  importGeoFolder: 'Geo-Ordner importieren',
